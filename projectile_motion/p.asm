...
# zakłądam że kąt jest już przeliczany na cos lub sin przy podaniu
projectile_motion:
    finit
    # rdi = pixelData 
    # xmm0 = v0 (float)
    ...
    movss xmm4, dword ptr [m]              # xmm3 = m
    movss xmm5, dword ptr [t]              # xmm4 = t
    movss xmm6, dword ptr [g]              # xmm5 = g
   
    # calculate vx
    movss xmm7, xmm0                      # v0
    mulss xmm7, xmm1                      # vx = v0 * cos(theta)

    # calculate vy
    movss xmm8, xmm1                      # v0
    mulss xmm8, xmm2                      # vy = v0 * sin(theta)
